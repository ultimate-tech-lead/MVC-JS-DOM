...
import { PrimerObservable } from '../../model/PrimerObservable';
...
export class AboutService {
  ...
  public primer: PrimerObservable = new PrimerObservable();
  ...
  async register(): Promise<void> {
    const url =
      'https://izbrisati-nedobog-da-stoji-ovako-gospodepomiluj.test/users/register';
    const payload = {
      username: 'ANGULAR16',
      password: 'ANGULAR16',
